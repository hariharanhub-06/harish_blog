...
const WORDS = [
    { word: "CHICKEN", hint: "The universal answer to 'What's for dinner?'" },
    { word: "CEREAL", hint: "Technically a soup, but we don't talk about that" },
    { word: "BANANA", hint: "A fruit that is also a phone if you're brave enough" },
    { word: "ZOMBIE", hint: "Someone who hasn't had their morning coffee yet" },
    { word: "GOSSIP", hint: "The only thing that travels faster than light" },
    { word: "KARAOKE", hint: "The art of singing badly with great confidence" },
    { word: "PIZZA", hint: "A delicious circle that comes in a square box" },
    { word: "SNEEZE", hint: "Your brain's way of rebooting the nose" },
    { word: "LAZY", hint: "Not messy, just 'selectively productive'" },
    { word: "BEDTIME", hint: "The time when you suddenly become a philosopher" },
    { word: "COFFEE", hint: "Survival juice for modern humans" },
    { word: "PUDDING", hint: "The ultimate proof that good things exist" },
    { word: "HAMSTER", hint: "A tiny floof on a never-ending treadmill" },
    { word: "MYSTERY", hint: "Where did the second sock go in the laundry?" },
    { word: "UNICORN", hint: "A horse that decided to be extra" },
    { word: "POPCORN", hint: "Corn that had a really big idea" },
    { word: "SKELETON", hint: "Someone who didn't eat their vegetables" },
    { word: "WIZARD", hint: "A guy who is never late, nor early" },
    { word: "DINOSAUR", hint: "A giant lizard that didn't see the rock coming" },
    { word: "MUFFIN", hint: "A cupcake that lost its frosting and dignity" },
    { word: "PIRATE", hint: "A businessman who works exclusively at sea" },
    { word: "SQUIRREL", hint: "A tiny ninja looking for hidden tree snacks" },
    { word: "CACTUS", hint: "A plant that just wants to be left alone" },
    { word: "COOKIE", hint: "A sweet disk used for bribing adults" },
    { word: "BICYCLE", hint: "A vehicle that can't stand up on its own because it's two-tired" }
];
