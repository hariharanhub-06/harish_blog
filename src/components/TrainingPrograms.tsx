                ...
                <div className="py-4 md:py-6 bg-white/5 border-y border-white/5 relative overflow-hidden backdrop-blur-sm">
                    ...
                    <InfiniteCarousel
                        items={skills.map((skill) => (
                            <div key={skill.id} className="shrink-0 flex items-center gap-3 md:gap-4 px-3 md:px-6 py-3 md:py-4 bg-white/5 rounded-xl md:rounded-2xl border border-white/10 hover:border-white/20 transition-colors w-[280px] md:w-[320px] min-w-[280px] md:min-w-[320px] h-full min-h-[70px] whitespace-normal">
                                <span className="relative text-lg md:text-2xl w-8 h-8 md:w-10 md:h-10 flex items-center justify-center overflow-hidden shrink-0">
