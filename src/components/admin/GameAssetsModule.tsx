...
export default function GameAssetsModule() {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            {/* Game Tab Switcher */}
            <div className="flex gap-2 p-1.5 bg-gray-100 dark:bg-white/10 rounded-2xl w-fit border border-gray-200 dark:border-white/10">
                {games.map((game) => (
                    <button
                        key={game.id}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-white dark:bg-[#1e1e1e] rounded-3xl p-6 border border-gray-100 dark:border-gray-800 shadow-sm space-y-6">
                        <h3 className="font-black text-lg text-gray-900 dark:text-white uppercase tracking-tight">Add New Asset</h3>

                        <div className="space-y-4">
                            <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-gray-200 dark:border-gray-700 border-dashed rounded-2xl cursor-pointer bg-gray-50 dark:bg-white/5 hover:bg-gray-100 dark:hover:bg-white/10 transition-all">
                                <div className="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
                                    {uploading ? (
                                        ...
                                        <>
                                            ...
                                            <p className="text-sm text-gray-600 dark:text-gray-300 font-bold">Click to upload photo</p>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 bg-gray-100 dark:bg-white/10 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-2.5 text-xs font-bold text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-primary/20 focus:outline-none transition-all"
                                        placeholder="https://..."
                                    />
                                    <button
                        ...
                        {currentGame.minAssets > 0 && (
                            <div className={`p-4 rounded-2xl flex items-center gap-3 ${
                                filteredAssets.length >= currentGame.minAssets
                        ...
                        <AnimatePresence>
                            {filteredAssets.map((asset) => (
                                <motion.div
                                    ...
                                    className="relative aspect-square rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-sm group bg-white dark:bg-[#1e1e1e]"
                                >
