    ...
    return (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="bg-white dark:bg-[#1e1e1e] rounded-[2.5rem] p-8 md:p-10 border border-gray-100 dark:border-gray-800 shadow-sm relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                            <h2 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">AI Master <span className="text-orange-600 italic">Knowledge Base</span></h2>
            ...
            <form onSubmit={handleSave} className="space-y-8">
                ...
                <div className="bg-white dark:bg-[#1e1e1e] rounded-[2.5rem] p-8 md:p-12 border border-gray-100 dark:border-gray-800 shadow-sm space-y-8 relative overflow-hidden">
                    ...
                    <textarea
                        ...
                        className="w-full bg-gray-50 dark:bg-[#2a2a2a] border-2 border-gray-100 dark:border-gray-700 rounded-[2rem] p-8 md:p-10 focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-bold min-h-[500px] text-lg text-gray-900 dark:text-white leading-relaxed placeholder:text-gray-300 outline-none"
